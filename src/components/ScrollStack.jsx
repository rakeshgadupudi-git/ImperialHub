...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    const endElementTop = endElement ? getElementOffset(endElement) : (useWindowScroll ? document.documentElement.scrollHeight : (scroller?.scrollHeight || 0));
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      const pinEnd = useWindowScroll 
        ...
        : ((scroller?.scrollHeight || 0) - containerHeight / 2);
